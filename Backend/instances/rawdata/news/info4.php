...
<html>
    <head>
        ...
        <script type="text/javascript" >
            function plotmaker(array2,str1,str2,str3) {
                ...
                if(array.length < 2) {
                    graphcontainer.innerHTML = 'The number of Covid infections is '.array[0];
                }
                else{
    ...
    <body>
        ...
        <script>
            plotmaker('<?php echo plotmaker('infection'); ?>','Number of Covid infections','Status in round','Infected people');
        </script>
    </body>       
</html>
