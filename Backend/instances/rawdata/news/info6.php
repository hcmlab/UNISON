...
<html>
    <head>
        ...
        <script type="text/javascript" >
            function plotmaker(array2,str1,str2,str3) {
                ...
                if(array.length < 2) {
                    graphcontainer.innerHTML = 'The current amount of hospitalized people '.array[0];
                }
                else{
    ...
    <body>
        ...
        <script>
            plotmaker('<?php echo plotmaker('hospital'); ?>','Current amount of hospitalized people','Status in round','People in hospital');
        </script>
    </body>       
</html>
