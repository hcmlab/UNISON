...
namespace Backend
{
    ...
    public class Response
    {
        ...
        public Response(string action, string requestUrl, string message, bool success = true)
        {
            ...
            string simplifiedMessage = this.message.ToLower();
        ...
        {
            string simplifiedMessage = message.ToLower();
        ...
        {
            if (int.TryParse(message, NumberStyles.Integer, CultureInfo.InvariantCulture, out int result))
            {
                value = result;
                return true;
            }
        ...
        {
            if (double.TryParse(message, NumberStyles.Float, CultureInfo.InvariantCulture, out double result))
            {
                value = result;
                return true;
            }
        ...
        public string GetRawResponse() => message;
        ...
        public ResponseType GetResponseType() => responseType;
    }
}