...
namespace Stations.Zones
{
    public class ExitZone : Interactable
    {
        ...
        protected override void StartAction()
        {
            ...
            {
                Station oldStation = WorldManager.ClientManager.PunClient.CurrentStation;
                    ...
                    ReactToGenericBoolResponse(response, () =>
                        {
                            ...
                            WorldManager.ClientManager.PunClient.SendNewEvent(GameEventType.OnStationLeft, GameEventResult.Success, oldStation.Type);
                            OnActionFinished();
                        },
                        () =>
                        {
                ...
                {
                    WorldManager.ClientManager.PunClient.SendNewEvent(GameEventType.OnStationLeft, GameEventResult.Error,
                        oldStation.Type);
                }
            }, Station.Type));
        }
