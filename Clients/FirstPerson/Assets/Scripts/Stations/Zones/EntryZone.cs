    ...
    public class EntryZone : Interactable
    {
        ...
        protected override void StartAction()
        {
            ...
            StartCoroutine(BackendConnection.VisitStation(response =>
            {
                    ...
                    ReactToGenericBoolResponse(response, () =>
                        {
                            ...
                            WorldManager.ClientManager.PunClient.SendNewEvent(GameEventType.OnStationEntered, GameEventResult.Success, Station.Type);
                            OnActionFinished();
                        }, () =>
                        {
                ...
                {
                    WorldManager.ClientManager.PunClient.SendNewEvent(GameEventType.OnStationEntered, GameEventResult.Error,
                        Station.Type);
                }
            }, Station.Type));
        }
