...
public static class LocalizationUtility
{
    ...
    public static string GetLocalizedString(params string[] stringKeys)
    {
        ...
        IEnumerable<string> localizedStrings = stringKeys.Select(key =>
    ...
    public static string GetTextForKeyCode(KeyCode keyCode)
    {
        ...
        if (KeyCodesWithTranslations.TryGetValue(keyCode, out string translatedKeyCode))
        {
            return GetLocalizedString(translatedKeyCode);
        }

        if (CleanKeyCodes.TryGetValue(keyCode, out string cleanKeyCode))
        {
            return cleanKeyCode;
        }
