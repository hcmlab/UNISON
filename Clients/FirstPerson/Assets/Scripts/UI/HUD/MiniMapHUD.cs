...
namespace UI.HUD
{
    ...
    public class MiniMapHUD : MonoBehaviourHUD, IStateSubscriber<Station>
    {
        ...
        private const float BigCameraSizeOutside = 96f;
        private const float BigCameraSizeInterior = 24f;
        
        private const float SmallPointerSizeOutside = 8f;
        private const float SmallPointerSizeInterior = 12f;
        private const float SmallCameraSizeOutside = 48f;
        private const float SmallCameraSizeInterior = 12f;
        ...
        private void ZoomCamSizeTo(float value) => CurrentWorldManager.minimapCamera.orthographicSize = value;
    }
}