...
namespace UI.Menu
{
    public class AvatarMenu : MonoBehaviour
    {
        ...
        private void RandomCustomization()
        {
            ...
            List<AvatarBody> avatarBodies = Enum.GetValues(typeof(AvatarBody)).Cast<AvatarBody>().ToList();
