...
namespace UI.Menu
{
    public class ControlMenu : MonoBehaviour
    {
        ...
        {
            foreach (PropertyInfo propertyInfo in ControlSettings.ControlData.GetType().GetProperties())
            {
                object value = propertyInfo.GetValue(ControlSettings.ControlData);
        ...
        private void AddAllControlSettings()
        {
            ...
            InstantiateKeyBindingButton("Sprint",
                ControlSettings.ControlData.Sprint,
                code => { ControlSettings.ControlData.Sprint = code; }
            );
            Instantiate(scrollViewSeparator, controlScrollView);

            InstantiateKeyBindingButton("Jump (Player)",
                ControlSettings.ControlData.Jump,
                code => { ControlSettings.ControlData.Jump = code; }
            );
        ...
        {
            KeyBindingButton keyBindingButton = Instantiate(keyBindingButtonPrefab, controlScrollView);
        ...
        {
            DoubleKeyBindingButton doubleKeyBindingButton =
