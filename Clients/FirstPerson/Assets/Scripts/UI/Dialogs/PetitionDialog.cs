...
namespace UI.Dialogs
{
    public class PetitionDialog : PetitionListDialog
    {
        ...
        public override void ToggleButtons(bool value, params CustomButton[] loadingButtons)
        {
            ...
            {
                foreach (CustomButton customButton in templates.GetComponentsInChildren<CustomButton>())
                {
        ...
        public void UpdatePetitionTemplateContent(string petitionSummaryText, UnityAction openPetitionButtonListener, UnityAction backToTemplateListButtonListener)
        {
        ...
        public string GetPetitionValueText() => petitionValue.text;

        public void UpdatePetitionSummaryText(string petitionSummaryText) => petitionSummary.text = petitionSummaryText;

        public string GetPetitionSummaryText() => petitionSummary.text;
