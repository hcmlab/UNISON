...
namespace UI.Dialogs
{
    public class GraphsDialog : OkDialog
    {
        ...
        public void Setup(string newTitle, string newMessage, string yesButtonText, UnityAction confirmAction, Dictionary<string, string> options)
        {
        ...
        private void UpdateGraph(int index)
        {
            ...
            string selectedGraph = optionsAsList[index];
            string url = availableGraphs[selectedGraph];
