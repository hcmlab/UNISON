...
namespace UI.Dialogs
{
    public class YesNoDialog : OkDialog
    {
        ...
        public void ResetNoButtonOnClickListener() => noButton.OnClick.RemoveAllListeners();

        public void AddNoButtonOnClickListener(UnityAction cancelAction) => noButton.OnClick.AddListener(cancelAction);

        public void UpdateNoButtonText(string noButtonText) => noButton.Text =
            LocalizationUtility.AddLocalizedKeyCode(ControlSettings.ControlData.CancelDialog, noButtonText);

        public void ToggleNoButtonVisibility(bool value) => noButton.gameObject.SetActive(value);
