...
namespace Backend.ResponseDataCapsules
{
    ...
    {
        [JsonConstructor]
        public Petition(int id, string positiveText, string negativeText, int proposedValue, int currentValue,
            string valueType, string scaleTitle, string status, List<int> yesVotes, List<int> noVotes)
        {
            ID = id;
