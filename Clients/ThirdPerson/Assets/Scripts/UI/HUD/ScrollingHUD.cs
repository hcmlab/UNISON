...
{
    /// <summary>
    ///     HUD scripts, that have a ScrollView inside, can extend this class. It notifies the ClientManager, that the mouse is
    ///     scrolling in a ScrollView and prevents unwanted parallel scrolling.
    /// </summary>
