    ...
    public class KeyBindingsOverviewHUD : MonoBehaviourHUD
    {
        ...
        private void Update()
        {
            if (SettingsMenu.KeyBindingsOverviewEnabled)
            {
                ...
                {
                    primaryForwardText.text =
                        LocalizationUtility.GetTextForKeyCode(ControlSettings.ControlData.PrimaryForward);
                    secondaryForwardText.text =
                        LocalizationUtility.GetTextForKeyCode(ControlSettings.ControlData.SecondaryForward);

                    primaryLeftText.text =
                        LocalizationUtility.GetTextForKeyCode(ControlSettings.ControlData.PrimaryLeft);
                    secondaryLeftText.text =
                        LocalizationUtility.GetTextForKeyCode(ControlSettings.ControlData.SecondaryLeft);

                    primaryRightText.text =
                        LocalizationUtility.GetTextForKeyCode(ControlSettings.ControlData.PrimaryRight);
                    secondaryRightText.text =
                        LocalizationUtility.GetTextForKeyCode(ControlSettings.ControlData.SecondaryRight);

                    primaryBackwardText.text =
                        LocalizationUtility.GetTextForKeyCode(ControlSettings.ControlData.PrimaryBackward);
                    secondaryBackwardText.text =
                        LocalizationUtility.GetTextForKeyCode(ControlSettings.ControlData.SecondaryBackward);

                    interactText.text = LocalizationUtility.GetTextForKeyCode(ControlSettings.ControlData.Interact);
                    toggleVoiceText.text =
                        LocalizationUtility.GetTextForKeyCode(ControlSettings.ControlData.ToggleVoice);
