...
namespace UI.Menu
{
    public class AudioMenu : MonoBehaviour
    {
        ...
        private void UpdateEffectsVolume(float value)
        {
            ...
            var scaledVolume = AudioSettings.ScaleVolume(value / gameSettings.MaxVolume);
        ...
        private void InitMenuItems()
        {
            ...
            var currentThreshold = recorder.VoiceDetectionThreshold * 100f;
            var adjustedCurrentThreshold =
        ...
        private void InitMicrophoneItemSwitch()
        {
            ...
            {
                var itemByNames = new Dictionary<string, string>();
