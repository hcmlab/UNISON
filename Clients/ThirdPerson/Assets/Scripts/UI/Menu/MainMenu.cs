    ...
    public class MainMenu : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (punManager.GameStarted && !gameStarted)
            {
                ...
                foreach (var b in avatarMenuButtons)
                {
        ...
        {
            var playerNameInputField = nameInputField.GetComponent<TMP_InputField>();
        ...
        private void AddAllListeners()
        {
            ...
            foreach (var b in quitButtons)
            {
                b.onClick.AddListener(OnQuit);
            }

            foreach (var b in controlMenuButtons)
            {
                b.onClick.AddListener(OnControl);
            }

            foreach (var b in audioMenuButtons)
            {
            ...
            foreach (var b in settingsButtons)
            {
